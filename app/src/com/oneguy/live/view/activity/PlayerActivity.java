...
import com.oneguy.live.module.play.NEMediaController;
import com.oneguy.live.module.play.NEVideoView;

import java.util.List;

/**
 * Created by ZuoShu on 16/7/17.
 */
public class PlayerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogHelper.warn(TAG, "playType = " + mMediaType);
        LogHelper.warn(TAG, "decodeType = " + mDecodeType);
        LogHelper.warn(TAG, "videoPath = " + mVideoPath);
        ...
        mVideoView.start();
        LogHelper.warn(TAG, "Version = " + mMediaPlayer.getVersion()); //获取解码库版本号
    ...
    protected void onStop() {
        LogHelper.warn(TAG, "NEVideoPlayerActivity onStop");
        super.onStop();
    }

    @Override
    protected void onPause() {
        LogHelper.warn(TAG, "NEVideoPlayerActivity onPause");
    ...
    protected void onDestroy() {
        LogHelper.warn(TAG, "NEVideoPlayerActivity onDestroy");
        mVideoView.release_resource();
        super.onDestroy();
    }
    ...
    protected void onStart() {
        LogHelper.warn(TAG, "NEVideoPlayerActivity onStart");
        super.onStart();
    }

    @Override
    protected void onResume() {
        LogHelper.warn(TAG, "NEVideoPlayerActivity onResume");
