...
public class Helper
{
	...
	public static org.joda.time.DateTime ConvertFromWebService(String strDate)
	{
    ...
    public static org.joda.time.LocalTime ConvertFromWebServiceTime(String strTime)
    {
        DateTimeFormatter parser1 = ISODateTimeFormat.time();
        return parser1.parseLocalTime(strTime);
    }

    public static org.joda.time.LocalDate ConvertFromWebServiceDate(String strTime)
    {
        try {
