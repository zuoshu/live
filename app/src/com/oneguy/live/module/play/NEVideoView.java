...
package com.oneguy.live.module.play;
...
import com.oneguy.live.control.util.LogHelper;
...
//            LogHelper.warn(TAG, "Video: width = " + mVideoWidth + ", height = " + mVideoHeight);
//            LogHelper.warn(TAG, "Surface: width = " + mSurfaceWidth + ", height = " + mSurfaceHeight);
//            LogHelper.warn(TAG, "Window:width = " + winWidth + ", height = " + winHeight);
//            LogHelper.warn(TAG, "LayoutParams:width = " + layPara.width + ", height = " + layPara.height);
        }
...
//            	neMediaPlayer.setHardwareDecoder(mHardwareDecoder);
    ...
    OnVideoSizeChangedListener mSizeChangedListener = new OnVideoSizeChangedListener() {
        public void onVideoSizeChanged(NELivePlayer mp, int width, int height,
            ...
            LogHelper.warn(TAG, "onVideoSizeChanged: " + width + "x"+ height);
    ...
    private OnSeekCompleteListener mSeekCompleteListener = new OnSeekCompleteListener() {
        ...
        public void onSeekComplete(NELivePlayer mp) {
            LogHelper.warn(TAG, "onSeekComplete");
    ...
    public void getSnapshot() {
        ...
        LogHelper.warn(TAG, "VideoDecoderMode = " + mediaInfo.mVideoDecoderMode);
        LogHelper.warn(TAG, "MediaPlayerName = " + mediaInfo.mMediaPlayerName);
        LogHelper.warn(TAG, "VideoStreamType = " + mediaInfo.mVideoStreamType);
        LogHelper.warn(TAG, "AudioDecoderMode = " + mediaInfo.mAudioDecoderMode);
        LogHelper.warn(TAG, "AudioStreamType = " + mediaInfo.mAudioStreamType);

        if (mediaInfo.mVideoDecoderMode.equals("MediaCodec"))
        {
            LogHelper.warn(TAG, "================= hardware unsupport snapshot ==============");
        }
        else
        {
