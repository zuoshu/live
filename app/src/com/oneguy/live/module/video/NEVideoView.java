...
import com.oneguy.live.control.util.StringUtil;
import com.oneguy.live.control.util.log.LogUtil;
import com.oneguy.live.control.util.storage.StorageType;
import com.oneguy.live.control.util.storage.StorageUtil;
        ...
        if (mVideoWidth > 0 && mVideoHeight > 0) {
            ...
            if (VideoConstant.VIDEO_SCALING_MODE_NONE == videoScalingMode && mSurfaceWidth < winWidth && mSurfaceHeight < winHeight) {
                ...
                if (winRatio > aspectRatio) {
                    // 屏幕宽按照高来计算
                    layPara.width = (int) (aspectRatio * (winHeight + rect.top));
